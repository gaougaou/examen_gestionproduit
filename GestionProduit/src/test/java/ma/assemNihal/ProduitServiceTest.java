...
public class ProduitServiceTest {
	...
	public void testSupprimerProduit() {
		Produit produit = new Produit(1L, "Souris", 29.99, 25);
		produitService.Ajouter(produit);

		produitService.supprimer(1L);
		assertEquals(0, produitService.Selecttous().size());
	}

	@Test(expected = IllegalStateException.class)
	public void testSupprimerNonExistingProduit() {
		produitService.supprimer(2L);
	}
